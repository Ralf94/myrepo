...
class TennisTest {
    ...
    public void checkTennisGameToBeRefactored(Class<? extends TennisGame> clazz, int pointsPlayer1, int pointsPlayer2, String exepctedResult) throws Exception {
        Constructor<? extends TennisGame> constructor = clazz.getConstructor(String.class, String.class);
        TennisGame game = constructor.newInstance("player1", "player2");
